...
class PostMatch(webapp2.RequestHandler):
    def post(self):
        ...
        match.winner1_cups = float(self.request.get('winner1_cups')) + float(self.request.get('winner1_bonus'))
        match.winner1_bonus = float(self.request.get('winner1_bonus'))
        match.winner2 = self.request.get('winner2')
        match.winner2_cups = float(self.request.get('winner2_cups')) + float(self.request.get('winner2_bonus'))
        match.winner2_bonus = float(self.request.get('winner2_bonus'))
        match.winner_total_cups = int(self.request.get('winner_total_cups'))
        match.loser1 = self.request.get('loser1')
        match.loser1_cups = float(self.request.get('loser1_cups')) + float(self.request.get('loser1_bonus'))
        match.loser1_bonus = float(self.request.get('loser1_bonus'))
        match.loser2 = self.request.get('loser2')
        match.loser2_cups = float(self.request.get('loser2_cups')) + float(self.request.get('loser2_bonus'))
        match.loser2_bonus = float(self.request.get('loser2_bonus'))
